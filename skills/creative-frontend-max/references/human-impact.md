...
| **3. Prueba** | Cumplir el contrato. Evidencia. | Proyectos | FleetVision (9 microservicios .NET 8), EfiziAI (voz + LLM), etc. **Números, arquitectura, decisiones. No screenshots bonitos: decisiones.** | Cero WebGL. Tipografía y foto. Este es el sacrificio que financia el pico. |
